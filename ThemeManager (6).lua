...
BuiltIn.Lavender = {
    FontColor = {245, 240, 255},
    MainColor = {30, 28, 40},
    BackgroundColor = {22, 20, 32},
    AccentColor = {180, 140, 255},
    OutlineColor = {55, 50, 70},
    RiskColor = {255, 50, 50},
}

BuiltIn.Rose = {
    FontColor = {255, 245, 248},
    MainColor = {34, 26, 30},
    BackgroundColor = {24, 18, 22},
    AccentColor = {255, 100, 150},
    OutlineColor = {60, 45, 55},
    RiskColor = {255, 70, 90},
}

BuiltIn.Ocean = {
    FontColor = {230, 245, 255},
    MainColor = {18, 26, 34},
    BackgroundColor = {12, 18, 26},
    AccentColor = {40, 180, 220},
    OutlineColor = {35, 50, 65},
    RiskColor = {255, 50, 50},
}

BuiltIn.Gold = {
    FontColor = {255, 250, 235},
    MainColor = {32, 28, 20},
    BackgroundColor = {22, 18, 12},
    AccentColor = {230, 180, 60},
    OutlineColor = {60, 50, 35},
    RiskColor = {255, 50, 50},
}
...
BuiltIn.Silver = {
    ...
    MainColor = {30, 30, 34},
    BackgroundColor = {22, 22, 26},
    AccentColor = {180, 185, 200},
    OutlineColor = {55, 55, 65},
    RiskColor = {255, 50, 50},
}
...
BuiltIn.Crimson = {
    FontColor = {255, 240, 240},
    MainColor = {32, 18, 20},
    BackgroundColor = {22, 12, 14},
    AccentColor = {200, 40, 60},
    OutlineColor = {55, 30, 35},
    RiskColor = {255, 80, 80},
}
...
BuiltIn.Matrix = {
    ...
    MainColor = {12, 18, 12},
    BackgroundColor = {8, 12, 8},
    AccentColor = {40, 220, 80},
    OutlineColor = {30, 50, 30},
    RiskColor = {255, 50, 50},
}

BuiltIn.Sky = {
    FontColor = {240, 248, 255},
    MainColor = {24, 30, 40},
    BackgroundColor = {16, 22, 32},
    AccentColor = {100, 170, 255},
    OutlineColor = {45, 55, 75},
    RiskColor = {255, 50, 50},
}

BuiltIn.Violet = {
    FontColor = {250, 245, 255},
    MainColor = {28, 22, 38},
    BackgroundColor = {18, 14, 28},
    AccentColor = {140, 80, 255},
    OutlineColor = {50, 40, 70},
    RiskColor = {255, 50, 50},
}

BuiltIn.Coral = {
    FontColor = {255, 245, 240},
    MainColor = {34, 26, 24},
    BackgroundColor = {24, 18, 16},
    AccentColor = {255, 120, 90},
    OutlineColor = {60, 45, 40},
    RiskColor = {255, 50, 50},
}
...
function ThemeManager:ApplyTable(data)
    ...
    -- Defer color + glass refresh so theme switch does not flash/bug mid-frame
    task.defer(function()
        pcall(function()
            if L.UpdateColorsUsingRegistry then L:UpdateColorsUsingRegistry() end
        end)
        pcall(function()
            if L.SetGlass then
                L:SetGlass(L.GlassEnabled ~= false, L.GlassTransparency or 0.55)
            end
        end)
        pcall(function()
            if L.UpdateColorsUsingRegistry then L:UpdateColorsUsingRegistry() end
...
-- ThemeManager expand 0
-- ThemeManager expand 1
-- ThemeManager expand 2
-- ThemeManager expand 3
-- ThemeManager expand 4
-- ThemeManager expand 5
-- ThemeManager expand 6
-- ThemeManager expand 7
-- ThemeManager expand 8
-- ThemeManager expand 9
-- ThemeManager expand 10
-- ThemeManager expand 11
-- ThemeManager expand 12
-- ThemeManager expand 13
-- ThemeManager expand 14
-- ThemeManager expand 15
-- ThemeManager expand 16
-- ThemeManager expand 17
-- ThemeManager expand 18
-- ThemeManager expand 19
-- ThemeManager expand 20
-- ThemeManager expand 21
-- ThemeManager expand 22
-- ThemeManager expand 23
-- ThemeManager expand 24
-- ThemeManager expand 25
-- ThemeManager expand 26
-- ThemeManager expand 27
-- ThemeManager expand 28
-- ThemeManager expand 29
-- ThemeManager expand 30
-- ThemeManager expand 31
-- ThemeManager expand 32
-- ThemeManager expand 33
-- ThemeManager expand 34
-- ThemeManager expand 35
-- ThemeManager expand 36
-- ThemeManager expand 37
-- ThemeManager expand 38
-- ThemeManager expand 39
-- ThemeManager expand 40
-- ThemeManager expand 41
-- ThemeManager expand 42
-- ThemeManager expand 43
-- ThemeManager expand 44
-- ThemeManager expand 45
-- ThemeManager expand 46
-- ThemeManager expand 47
-- ThemeManager expand 48
-- ThemeManager expand 49
-- ThemeManager expand 50
-- ThemeManager expand 51
-- ThemeManager expand 52
-- ThemeManager expand 53
-- ThemeManager expand 54
-- ThemeManager expand 55
-- ThemeManager expand 56
-- ThemeManager expand 57
-- ThemeManager expand 58
-- ThemeManager expand 59
-- ThemeManager expand 60
-- ThemeManager expand 61
-- ThemeManager expand 62
-- ThemeManager expand 63
-- ThemeManager expand 64
-- ThemeManager expand 65
-- ThemeManager expand 66
-- ThemeManager expand 67
-- ThemeManager expand 68
-- ThemeManager expand 69
-- ThemeManager expand 70
-- ThemeManager expand 71
-- ThemeManager expand 72
-- ThemeManager expand 73
-- ThemeManager expand 74
-- ThemeManager expand 75
-- ThemeManager expand 76
-- ThemeManager expand 77
-- ThemeManager expand 78
-- ThemeManager expand 79
-- ThemeManager expand 80
-- ThemeManager expand 81
-- ThemeManager expand 82
-- ThemeManager expand 83
-- ThemeManager expand 84
-- ThemeManager expand 85
-- ThemeManager expand 86
-- ThemeManager expand 87
-- ThemeManager expand 88
-- ThemeManager expand 89
-- ThemeManager expand 90
-- ThemeManager expand 91
-- ThemeManager expand 92
-- ThemeManager expand 93
-- ThemeManager expand 94
-- ThemeManager expand 95
-- ThemeManager expand 96
-- ThemeManager expand 97
-- ThemeManager expand 98
-- ThemeManager expand 99
-- ThemeManager expand 100
-- ThemeManager expand 101
-- ThemeManager expand 102
-- ThemeManager expand 103
-- ThemeManager expand 104
-- ThemeManager expand 105
-- ThemeManager expand 106
-- ThemeManager expand 107
-- ThemeManager expand 108
-- ThemeManager expand 109
-- ThemeManager expand 110
-- ThemeManager expand 111
-- ThemeManager expand 112
-- ThemeManager expand 113
-- ThemeManager expand 114
-- ThemeManager expand 115
-- ThemeManager expand 116
-- ThemeManager expand 117
-- ThemeManager expand 118
-- ThemeManager expand 119
-- ThemeManager expand 120
-- ThemeManager expand 121
-- ThemeManager expand 122
-- ThemeManager expand 123
-- ThemeManager expand 124
-- ThemeManager expand 125
-- ThemeManager expand 126
-- ThemeManager expand 127
-- ThemeManager expand 128
-- ThemeManager expand 129
-- ThemeManager expand 130
-- ThemeManager expand 131
-- ThemeManager expand 132
-- ThemeManager expand 133
-- ThemeManager expand 134
-- ThemeManager expand 135
-- ThemeManager expand 136
-- ThemeManager expand 137
-- ThemeManager expand 138
-- ThemeManager expand 139
-- ThemeManager expand 140
-- ThemeManager expand 141
-- ThemeManager expand 142
-- ThemeManager expand 143
-- ThemeManager expand 144
-- ThemeManager expand 145
-- ThemeManager expand 146
-- ThemeManager expand 147
-- ThemeManager expand 148
-- ThemeManager expand 149
-- ThemeManager expand 150
-- ThemeManager expand 151
-- ThemeManager expand 152
-- ThemeManager expand 153
-- ThemeManager expand 154
-- ThemeManager expand 155
-- ThemeManager expand 156
-- ThemeManager expand 157
-- ThemeManager expand 158
-- ThemeManager expand 159
-- ThemeManager expand 160
-- ThemeManager expand 161
-- ThemeManager expand 162
-- ThemeManager expand 163
-- ThemeManager expand 164
-- ThemeManager expand 165
-- ThemeManager expand 166
-- ThemeManager expand 167
-- ThemeManager expand 168
-- ThemeManager expand 169
-- ThemeManager expand 170
-- ThemeManager expand 171
-- ThemeManager expand 172
-- ThemeManager expand 173
-- ThemeManager expand 174
-- ThemeManager expand 175
-- ThemeManager expand 176
-- ThemeManager expand 177
-- ThemeManager expand 178
-- ThemeManager expand 179
-- ThemeManager expand 180
-- ThemeManager expand 181
-- ThemeManager expand 182
-- ThemeManager expand 183
-- ThemeManager expand 184
-- ThemeManager expand 185
-- ThemeManager expand 186
-- ThemeManager expand 187
-- ThemeManager expand 188
-- ThemeManager expand 189
-- ThemeManager expand 190
-- ThemeManager expand 191
-- ThemeManager expand 192
-- ThemeManager expand 193
-- ThemeManager expand 194
